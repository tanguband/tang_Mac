				...
				case RBM_SHOW:
				{
					...
					if (m_ptr->r_idx == MON_JAIAN)
					{
						...
						switch(randint1(15))
						{
						  ...
						  case 6:
						  case 11:
							act = "「♪おーれはジャイアンーーガーキだいしょうー」";
							break;
						  case 2:
							act = "「♪てーんかむーてきのおーとこだぜーー」";
							break;
						  case 3:
							act = "「♪のーび太スネ夫はメじゃないよーー」";
							break;
						  case 4:
							act = "「♪けーんかスポーツーどんとこいー」";
							break;
						  case 5:
							act = "「♪うたーもーーうーまいぜーまかしとけー」";
							break;
						  case 7:
							act = "「♪まーちいちばーんのにーんきものーー」";
							break;
						  case 8:
							act = "「♪べんきょうしゅくだいメじゃないよーー」";
							break;
						  case 9:
							act = "「♪きはやさしーくてーちーからもちー」";
							break;
						  case 10:
							act = "「♪かおーもーースタイルもーバツグンさー」";
							break;
						  case 12:
							act = "「♪がっこういーちのーあーばれんぼうーー」";
							break;
						  case 13:
							act = "「♪ドーラもドラミもメじゃないよーー」";
							break;
						  case 14:
							act = "「♪よじげんぽけっとーなーくたってー」";
							break;
						  case 15:
							act = "「♪あしーのーーながさーはーまけないぜー」";
							break;
						}
#else
